...
graph TD
    ...
    Actions --> BashAction[BashAction]
    Actions --> FileEditAction[FileEditAction]
    
    Observations --> BashObservation[BashObservation]
    Observations --> FileEditObservation[FileEditObservation]
    
    Executor --> BashExecutor[BashExecutor]
    Executor --> FileEditorExecutor[FileEditorExecutor]
    
    style Tool fill:#e1f5fe
    style Actions fill:#fff3e0
    style Observations fill:#f3e5f5
